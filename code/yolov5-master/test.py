...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / '../../data/rubbish_first_combine_standard.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/rubbish_first_combine_standard/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='rubbish_first_combine_standard_finetune', help='save to project/name')
